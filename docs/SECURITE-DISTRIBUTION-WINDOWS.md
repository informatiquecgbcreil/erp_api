...
| MCS-20 | Un compte borné à son secteur (sans `participants:view_all`, comme le nouveau rôle animateur) ouvrait et modifiait par son adresse la fiche complète d'un participant d'un autre secteur (e-mail, téléphone, adresse), alors que la synthèse le refusait déjà. | Fiche ouverte seulement pour les publics de son secteur, en lecture comme en écriture. Les rôles qui ont l'annuaire complet ne changent pas. |
